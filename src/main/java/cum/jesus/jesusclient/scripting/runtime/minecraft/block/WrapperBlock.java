package cum.jesus.jesusclient.scripting.runtime.minecraft.block;

import cum.jesus.jesusclient.scripting.runtime.minecraft.block.material.WrapperMaterial;
import cum.jesus.jesusclient.scripting.runtime.minecraft.block.state.WrapperBlockState;
import cum.jesus.jesusclient.scripting.runtime.minecraft.block.state.WrapperIBlockState;
import cum.jesus.jesusclient.scripting.runtime.minecraft.entity.WrapperEntity;
import cum.jesus.jesusclient.scripting.runtime.minecraft.entity.WrapperEntityLivingBase;
import cum.jesus.jesusclient.scripting.runtime.minecraft.entity.player.WrapperEntityPlayer;
import cum.jesus.jesusclient.scripting.runtime.minecraft.item.WrapperItem;
import cum.jesus.jesusclient.scripting.runtime.minecraft.util.WrapperAxisAlignedBB;
import cum.jesus.jesusclient.scripting.runtime.minecraft.util.WrapperBlockPos;
import cum.jesus.jesusclient.scripting.runtime.minecraft.util.WrapperEnumFacing;
import cum.jesus.jesusclient.scripting.runtime.minecraft.util.WrapperVec3;
import cum.jesus.jesusclient.scripting.runtime.minecraft.world.WrapperWorld;
