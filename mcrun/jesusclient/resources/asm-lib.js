...
const ASMDescriptor = Java.type("dev.falsehonesty.asmhelper.dsl.Descriptor");
const asmInjectHelper = Java.type("cum.jesus.jesusclient.script.language.js.JSHelper").INSTANCE.asmInjectHelper;
const asmRemoveHelper = Java.type("cum.jesus.jesusclient.script.language.js.JSHelper").INSTANCE.asmRemoveHelper;
const asmFieldHelper = Java.type("cum.jesus.jesusclient.script.language.js.JSHelper").INSTANCE.asmFieldHelper;
            ...
            if (key === 'invokeJS') {
                ...
                return functionId => {
                    let handle = target.builder.handle.bind(target.builder)(
                        ...
                        "cum/jesus/jesusclient/injection/IndySupport",
                        "bootstrapInvokeJS",
...
class InjectBuilder extends ASMBuilder {
    ...
    execute() {
        ...
        asmInjectHelper(this.className, this.methodName, this.descriptor, this.at, this._fieldMaps, this._methodMaps, this.insnList);
    }
}
